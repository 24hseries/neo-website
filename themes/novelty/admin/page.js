(function($){
	...
	$(function(){
		...
		var show_template_options = function(){
			...
			$('#novelty_metabox_template_options [data-template]').hide();

			$('#novelty_metabox_template_options [data-template] [name]').prop('disabled', true);

			$('#novelty_metabox_template_options [data-template="'+$('#page_template').val()+'"]').show();

			$('#novelty_metabox_template_options [data-template="'+$('#page_template').val()+'"] [name]').prop('disabled', false);
