...
<div class="filter-area">
    <div class="container">
                ...
                <div class="span<?php echo has_post_thumbnail($slide['post']->ID)?5:12; ?>">
                    <div class="project-details">
                        <ul class="project-selection">
                            <?php previous_post_link('<li>%link</li>',_x('prev','single project page','novelty')); ?>
                            <?php next_post_link('<li>%link</li>',_x('next','single project page','novelty')); ?>
                        </ul>
                        <h1><?php echo get_the_title($slide['post']->ID); ?></h1>
                        <ul class="project-info">
                            <li><span><?php echo $slide['options']['author']; ?></span><?php _ex('Author','single project page','novelty'); ?></li>
                            <li><span><?php echo get_the_time('d.m.Y',$slide['post']->ID); ?></span><?php _ex('Date','single project page','novelty'); ?></li>
                            <li><span><?php echo implode(', ', $slide['categories']); ?></span><?php echo _nx('Category','Categories',count($slide['categories']),'single project page','novelty'); ?></li>
                        </ul>
        ...
        <h1 class="center"><?php _ex('<span>Related</span> projects','single project page','novelty'); ?></h1>
        <br/>
