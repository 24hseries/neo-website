...
class Novelty_widget_banner extends WP_Widget {

    function __construct() {
        parent::__construct(
                'novelty_widget_banner',
                'Novelty - Banner',
                array(
                    'description' => __('Displays an image with a link', 'novelty'),
                    'classname' => 'novelty_widget_banner',
                )
        );
    }
    ...
    function form($instance) {
        ...
        ?>
        <div class="novelty_widget_banner">
            <p>
            ...
            <p>
                <label><?php _e('URL:','novelty'); ?><input class="widefat" name="<?php echo $this->get_field_name('url'); ?>" type="text" value="<?php echo $url; ?>" /></label>
            </p>
            <p>
                <label><input name="<?php echo $this->get_field_name('target'); ?>" type="checkbox" <?php checked($target); ?> value="1" /> <?php _e('Open link in a new window/tab','novelty'); ?></label>
            </p>
        </div>
        <?php
    }
