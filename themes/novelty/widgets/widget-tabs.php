...
class Novelty_widget_tabs extends WP_Widget {
    ...
    function __construct() {
        parent::__construct(
                ...
                'Novelty - Tabs',
                array(
                    'description' => __('Tabs with the latest post from specified categories', 'novelty'),
                    'classname' => 'novelty_widget_tabs tabs',
                )
        );
    }
                        ...
                        foreach($query as $q){
                            ...
                            echo
                                '<div>
                                    ...
                                    <div class="tab-date">
                                        <span>'._x('Posted :', 'tabs widget', 'novelty').'</span> '.get_the_time('j M', $q->ID).'
                                    </div>
                                </div>';
    ...
    function form($instance) {
        $instance = wp_parse_args((array) $instance, array('title' => '', 'nr' => 3, 'categories' => array(''), 'image_size' => 'thumbnail'));
        ...
        <div class="novelty_widget_tabs">
            <?php foreach ($categories as $value): ?>
                <p>
                    <?php $this->novelty_option(array('cats'=>$categories_all,'value'=>$value,'disabled'=>false)); ?>
                </p>
            <?php endforeach; ?>
            <p>
                <?php $this->novelty_option(array('cats'=>$categories_all,'value'=>'','disabled'=>true)); ?>
            </p>
        </div>
        <p>
