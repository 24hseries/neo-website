...
class Novelty_widget_twitter extends WP_Widget {

    function __construct() {
        parent::__construct(
                'novelty_widget_twitter',
                'Novelty - Twitter',
                array(
                    'description' => __('Displays latest tweets', 'novelty'),
                    'classname' => 'novelty_widget_twitter',
                )
        );
    }
    ...
    function form($instance) {
        ...
        <p>
            <label><?php _e('Twitter user:','novelty'); ?><input class="widefat" name="<?php echo $this->get_field_name('user'); ?>" type="text" value="<?php echo $user; ?>" /></label> 
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('nr'); ?>">
                <?php _e('Number of tweets to show:','novelty'); ?>
