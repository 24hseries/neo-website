jQuery( document ).ready(function() {
	...
	var url_php = 'https://neo-endurance.com/php/show_data.php';
	...
	jQuery.getJSON(url_php,function(data){
		...
		jQuery.each(data, function(index, data){
			...
			if(data.TeamTwitter != ""){
				twitter = '<td VALIGN="top"><a href="http://www.twitter.com/'+ data.TeamTwitter +'" target="_blank"><img class="flag" src="/op-images/twitterlogo.png" width="20" title="@' +  data.TeamTwitter + '" alt="'+data.TeamTwitter+'"/></a></td>';	
			}
			else{
				twitter = '<td></td>';	
			}
			...
			if(data.TeamWebsite != ""){
				website = '<td VALIGN="top"><a href="'+ data.TeamWebsite +'" target="_blank"><img class="flag" src="/op-images/websitelogo.png" width="20" title="' +  data.TeamName + '" alt="'+data.TeamWebsite+'"/></a></td>';	
			}
			else{
				website = '<td></td>';	
			}
