 ...
 */
 ...
 $column_attributes = array(
     array(
         ...
         'heading' => __( 'Responsive Padding', 'gillion' ),
         'description' => __( 'Here you can set responsive smartphone and tablet padding (<b>top right bottom left</b>). For example: <b>30px 0px 30px 0px</b>', 'gillion' ),
         'type' => 'textfield',
         'group' => __( 'Extras', 'gillion' ),
     ),
     array(
         'param_name' => 'max_width',
         'heading' => __( 'Max Width', 'gillion' ),
         'description' => __( 'Enter columns content max width (Note: CSS measurement units allowed).', 'gillion' ),
         'type' => 'textfield',
         'group' => __( 'Extras', 'gillion' ),
     ),
     array(
         ...
         'value' => array(
             ...
             __( 'Shadow 2', 'gillion' ) => 'shadow2',
             __( 'Shadow 3', 'gillion' ) => 'shadow3',
         ),
         'description' => __( 'Choose Column Shadow', 'gillion' ),
         'group' => __( 'Extras', 'gillion' ),
     ),
 );
 ...
 $row_attributes = array(
     ...
     array(
         ...
         'value' => array(
             __( 'Default', 'gillion' ) => 'default',
             __( 'Reversed', 'gillion' ) => 'reversed',
         ),
         'description' => __( 'Choose responsive column order for smartphones and tablets', 'gillion' ),
         'group' => __( 'Extras', 'gillion' ),
     ),
     array(
         'type' => 'dropdown',
         ...
         'value' => array(
             __( 'Disabled', 'gillion' ) => 'disabled',
             __( 'Standard', 'gillion' ) => 'standard',
         ),
         'description' => __( 'Add parallax type background for row (Note: If no image is specified, parallax will use background image from Design Options). Also standard parallax should be disabled', 'gillion' ),
         'group' => __( 'Extras', 'gillion' ),
     ),
 );
