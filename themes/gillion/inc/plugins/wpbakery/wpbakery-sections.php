...
function custom_post_type() {
    ...
    // Templates
    $labels = array(
		'name'                  => _x( 'Page Templates', 'Post Type General Name', 'jevelin' ),
		'singular_name'         => _x( 'Page Template', 'Post Type Singular Name', 'jevelin' ),
		'menu_name'             => __( 'Page Templates', 'jevelin' ),
		'name_admin_bar'        => __( 'Page Template', 'jevelin' ),
		'archives'              => __( 'Item Archives', 'jevelin' ),
		'attributes'            => __( 'Item Attributes', 'jevelin' ),
		'parent_item_colon'     => __( 'Parent Item:', 'jevelin' ),
		'all_items'             => __( 'All Items', 'jevelin' ),
		'add_new_item'          => __( 'Add New Page Template', 'jevelin' ),
		'add_new'               => __( 'Add New', 'jevelin' ),
		'new_item'              => __( 'New Item', 'jevelin' ),
		'edit_item'             => __( 'Edit Item', 'jevelin' ),
		'update_item'           => __( 'Update Item', 'jevelin' ),
	...
	$args = array(
		'label'                 => __( 'Page Template', 'jevelin' ),
		'description'           => __( 'Use page templates to set posts, 404 and other pages structures', 'jevelin' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'revisions' ),
		//'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
	...
	register_post_type( 'shufflehound_temp', $args );
