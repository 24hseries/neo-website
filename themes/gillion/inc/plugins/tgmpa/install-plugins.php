    ...
    function gillion_register_required_plugins() {
        ...
        tgmpa(array(
            ...
            array(
                ...
                'image'     => 'wpbakery.png',
                'slug'      => 'js_composer',
                'source'    => 'https://cdn.shufflehound.com/theme-plugins/visual-composer-OL6A44-6.0.5.zip?ver=6.3',
                'required'  => true,
                'version'   => '6.3',
            ),
            ...
            array(
                ...
                'slug'      => 'revslider',
                'source'    => 'https://cdn.shufflehound.com/theme-plugins/slider-revolution-QB4L22.zip?ver=6.2.22',
                'required'  => false,
                'version'   => '6.2.22',
            ),
            ...
            array(
                'order'     => 7,
                'name'      => esc_html__( 'Twitter Feed', 'gillion' ),
                'desc'      => 'Embed twitter feed with oAuth twitter feed for developers',
                'image'     => 'twitter-feed.png',
