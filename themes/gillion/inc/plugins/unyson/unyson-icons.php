 ...
 * Define Icons
 */
if( !function_exists( 'gillion_icon_set' ) ) {
    function gillion_icon_set($sets) {
        $sets['gillion-icons'] = array(
            'font-style-src' => fw_get_framework_directory_uri('/static/libs/font-awesome/css/font-awesome.min.css'),
            'container-class' => 'fa-lg',
            'groups' => array(
                'fa' => esc_html__('Font Awesome', 'gillion'),
                'si' => esc_html__('Simple Line Icons', 'gillion'),
                'ti' => esc_html__('Themify Icons', 'gillion'),
                'pi' => esc_html__('Pixeden Icons', 'gillion'),
            ),
            'icons'  => array(
                ...
                'icon-symble-female' => array( 'group' => 'si' ),
                ...
                'icon-social-gplus' => array( 'group' => 'si' ),
    ...
    add_filter('fw_option_type_icon_sets', 'gillion_icon_set');
}
