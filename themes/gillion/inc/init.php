	...
	public static function init()
	{
		 ...
		 */
		{
			...
			if( function_exists('kc_add_map') ) :
				self::include_child_first('/elements.php');
			endif;
	...
	public static function _action_widgets_init()
	{
		...
		foreach ($paths as $path) {
			...
			foreach ($dirs as $dir) {
				...
				$class = $dirname;
				if( $dirname == 'posts-recent' ) :
					$class = 'posts-slider';
				elseif( $class == 'posts-recent-old' ) :
					$class = 'recent-posts';
				endif;

				$widget_class = 'Widget_' . self::dirname_to_classname( $class );
