...
class vcg_single_post_media extends WPBakeryShortCode {

    function __construct() {
        add_action( 'init', array( $this, '_mapping' ), 12 );
        add_shortcode( 'vcg_single_post_media', array( $this, '_html' ) );
    }
    ...
    public function _mapping() {
        ...
        vc_map(
            array(
                'name' => __('Single Post Media', 'jevelin'),
                'base' => 'vcg_single_post_media',
                ...
                <p>
                    <?php
                        if( is_single() ) :
                            ...
                            esc_attr_e( 'Single post media', 'jevelin' );
                        endif;
                    ?>
                </p>
            </div>
