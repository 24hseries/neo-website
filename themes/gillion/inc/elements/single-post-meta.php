...
class vcg_single_post_meta extends WPBakeryShortCode {

    function __construct() {
        add_action( 'init', array( $this, '_mapping' ), 12 );
        add_shortcode( 'vcg_single_post_meta', array( $this, '_html' ) );
    }
    ...
    public function _mapping() {
        ...
        vc_map(
            array(
                'name' => __('Single Post Meta', 'jevelin'),
                'base' => 'vcg_single_post_meta',
