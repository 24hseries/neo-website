...
class vcg_single_comments extends WPBakeryShortCode {

    function __construct() {
        add_action( 'init', array( $this, '_mapping' ), 12 );
        add_shortcode( 'vcg_single_comments', array( $this, '_html' ) );
    }
    ...
    public function _mapping() {
        ...
        vc_map(
            array(
                'name' => __('Single Comments', 'jevelin'),
                'base' => 'vcg_single_comments',
                ...
                <p>
                    <?php
                        if( is_single() ) :
                            ...
                            esc_attr_e( '[Comments goes here]', 'jevelin' );
                        endif;
                    ?>
                </p>
            </div>
