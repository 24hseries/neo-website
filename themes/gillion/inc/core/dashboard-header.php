...
?>
    ...
    <div class="shufflehound-dashboard-header">
        <di class="shufflehound-dashboard-navigation-container">
            <ul class="shufflehound-dashboard-navigation shufflehound-dashboard-navigation-left">
                ...
                <?php if( !( gillion_framework() == 'redux' && !defined( 'FW' ) ) ) : ?>
                    <li<?php echo ( $page == 'shufflehound_framework_upgrade' ) ? ' class="active"' : ''; ?>>
                        <a href="<?php echo admin_url( 'admin.php?page=shufflehound_framework_upgrade' ); ?>">
                            <?php esc_html_e( 'Upgrade', 'shufflehound' ); ?>
                        </a>
                    </li>
                <?php endif; ?>
                ...
                <li<?php echo ( $page == 'shufflehound_customize' || $page == 'fw-settings' || $page == 'gillion-theme-settings' ) ? ' class="active"' : ''; ?>>
    ...
    <style media="screen">
        ...
        <?php if( $theme_name == 'gillion' ) : ?>
            ...
            .fw-settings-form .button.wp-color-result > .color-alpha {
...
// Add header to pages
$page = ( isset( $_GET['page'] ) && $_GET['page'] ) ? $_GET['page'] : '';
if( $page == 'pt-one-click-demo-import' || $page == 'fw-settings' || $page == 'tgmpa-install-plugins' || $page == 'tgmpa-install-plugins' || $page == 'gillion-theme-settings' ) :
