...
function shufflehound_framework_upgrade_page() {
    ...
    $msg = '';
    if( $method == 'full' && gillion_framework() == 'unyson' && class_exists( 'Redux' ) ) :
        $msg = gillion_framework_migrate_redux( 'start' );
    elseif( $method == 'partial' && gillion_framework() == 'unyson' && class_exists( 'Redux' ) ) :
        update_option( 'gillion_framework', 'redux' );
        $msg = 'Done!';
    elseif( $method == 'downgrade' ) :
        delete_option( 'gillion_framework' );
        $msg = 'You are now using Unyson Framework';
    endif;


    // Get current step
    if( gillion_framework() == 'redux' && !defined( 'FW' ) ) :
        $step = 4;
    elseif( gillion_framework() == 'redux' && defined( 'FW' ) ) :
        $step = 3;
    elseif( gillion_framework() == 'unyson' && class_exists( 'Redux' ) ) :
        $step = 2;
    else :
        $step = 1;
    endif;
?>
    ...
    <div class="shufflehound-dashboard-content">
        <div class="shufflehound-dashboard-message" style="padding-top: 0;">
            ...
            <p>
                Gillion is upgrading its main framework from Unyson to Redux Framework.<br>
