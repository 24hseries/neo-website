...
if ( is_customize_preview() || ( is_admin() && defined( 'DOING_AJAX' ) && DOING_AJAX ) || defined( 'DOING_CRON' ) ) {
    ...
    $customizer_mode = 1;
    include get_template_directory() . '/inc/framework-customizations/theme/options/lightbox.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/woocommerce.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/styling.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/header.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/general.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/footer.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/titlebar.php';
    include get_template_directory() . '/inc/framework-customizations/theme/options/social_media.php';
